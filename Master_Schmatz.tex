...
\noindent Das Chassis wurde aus Sperrholz gefertigt. Dieses Material wurde gewählt weil es leicht zu bearbeiten, robust und UV-beständig ist. Das Design wurde mit QCAD [\ref{qc}] entwickelt. QCAD ist ein 2-dimensionales CAD Programm. 
...
\end{tabular}
\caption{Die Messwerte der Kalibrierung von den Messschaltungen A und B.}\label{TabAB}
\end{table}
