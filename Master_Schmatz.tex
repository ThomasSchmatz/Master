...
Und nun zur Regelung der Seitwärtsfahrt. Wieder wird versucht die Abweichung in Verschiebung, diesmal in vor- und zurück-Richtung, und der Verdrehung zu minimieren.  Allerdings hat das Seitwätsfahren eine andere Dynamik als das Geradeausfahren. Die Geradeausfahrt eines Mecanum-Fahrzeuges ist vergleichbar mit der eines konventionellen Fahrzeuges. Dagegen ist die Seitwärtsfahrt nicht so flüssig. 
Daher sind die Schaltwerte für die Seitwärtsregelung auch anders als die Geradeausregelung (siehe Abbildung \ref{reg}).
