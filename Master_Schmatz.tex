...
Dir Größe der Messzelle, zusammen mit dem Raddurchmesser und der Breite der Räder gibt eine Minimalabmessung vor die der Roboter nicht unterschreiten kann. Zusätzlich müssen noch die Motoren, der Akku und die Elektronik im Inneren des Roboters Platz finden.
Designprozess:
...
\begin{figure}
    \subfigure[Vor/Zurück]{\includegraphics[width=0.49\textwidth]{img/gerade.png}}
    \subfigure[Links/Rechts]{\includegraphics[width=0.49\textwidth]{img/seitw.png}}
     \subfigure[Drehen]{\includegraphics[width=0.49\textwidth]{img/dreh.png}}
...
\newline
\newline
Aus der Matrix $\begin{pmatrix} 1 \\ . \\ . \\ . \\ 308  \end{pmatrix} $ wird die Matrix

$\begin{pmatrix} 1 & . &.& .& 14\\ 28& .& .& . &15 \\ 29 &. &.& .& 42 \\ . &.& .& . & . \\ 298 &.& .&.& 308  \end{pmatrix} $ 
\newline
\newline
