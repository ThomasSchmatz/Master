...
Was ist AM1,5? Warum 1000W pro Meter2? --> Hinweis auf normative Grundlagen
...
Die Prüfebene ist 2,50 mal 4 Meter groß.
...
Der Kurzschlussstrom einer Solarzelle ist linear von der Bestrahlungsstärke anhängig.



\begin{figure}[htbp]
\centering
\includegraphics[width=100mm]{img/BandDiagramSolarCell.PNG}
\caption[Bandabstand]{Bandabstand}\label{tempkoef}
\end{figure}


\chapter{Entwicklungprozess}\thispagestyle{empty}

Ersatzschaltbild (Ein- dioden oder zweidiodenmodel), Erklärung der Funktion der einzelnen Bauteile: Stromquelle, Diode(n), Serienwiderstand, Parallelwiderstand

Abhängigkeit von I-Sc von der Temperatur (und auch U-os und damit auch P-mpp)
