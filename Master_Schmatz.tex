...
Es wird empfohlen vor jeden Messzyklus den Akku zu laden. Ein voller Akku kann ohne Probleme 10 Messfahrten absolvieren. Der Akku ist mit einer im Anschlusskabel integrierten Schmelzsicherung geschützt. Zum Laden des Akkus muss der Akku vom Roboter abgesteckt werden, inklusive den Balancer-Anschlüsse. Zum Laden wird ein Ultramat 16 V verwendet. 
...
Die Analog-Digitalwandlung des Arduino benötigt eine Referenzspannung. Das kann die Versorgungsspannung sein, was aber doch zu ungenau ist. Als Spannungsreferenz wird ein LT1021 5V Präzisionsspannungsquelle verwendet.
